...
- `brand-voice` ΓÇö canonical source-derived writing-style system.
- `social-graph-ranker` ΓÇö weighted warm-intro graph ranking primitive.
- `connections-optimizer` ΓÇö network pruning/addition workflow on top of graph ranking.
...
- `typescript-reviewer` ΓÇö TypeScript/JavaScript code review specialist (#647)
- `pytorch-build-resolver` ΓÇö PyTorch runtime, CUDA, and training error resolution (#549)
- `java-build-resolver` ΓÇö Maven/Gradle build error resolution (#538)
- `java-reviewer` ΓÇö Java and Spring Boot code review (#528)
- `kotlin-reviewer` ΓÇö Kotlin/Android/KMP code review (#309)
- `kotlin-build-resolver` ΓÇö Kotlin/Gradle build errors (#309)
- `rust-reviewer` ΓÇö Rust code review (#523)
- `rust-build-resolver` ΓÇö Rust build error resolution (#523)
- `docs-lookup` ΓÇö Documentation and API reference research (#529)

### New Skills

- `pytorch-patterns` ΓÇö PyTorch deep learning workflows (#550)
- `documentation-lookup` ΓÇö API reference and library doc research (#529)
- `bun-runtime` ΓÇö Bun runtime patterns (#529)
- `nextjs-turbopack` ΓÇö Next.js Turbopack workflows (#529)
- `mcp-server-patterns` ΓÇö MCP server design patterns (#531)
- `data-scraper-agent` ΓÇö AI-powered public data collection (#503)
- `team-builder` ΓÇö Team composition skill (#501)
- `ai-regression-testing` ΓÇö AI regression test workflows (#433)
- `claude-devfleet` ΓÇö Multi-agent orchestration (#505)
- `blueprint` ΓÇö Multi-session construction planning
- `everything-claude-code` ΓÇö Self-referential ECC skill (#335)
- `prompt-optimizer` ΓÇö Prompt optimization skill (#418)
...
- `/docs` ΓÇö Documentation lookup (#530)
- `/aside` ΓÇö Side conversation (#407)
- `/prompt-optimize` ΓÇö Prompt optimization (#418)
- `/resume-session`, `/save-session` ΓÇö Session management
...
- Biome hook optimization ΓÇö eliminated npx overhead (#359)
...
- Korean (ko-KR) translation ΓÇö README, agents, commands, skills, rules (#392)
- Chinese (zh-CN) documentation sync (#428)

### Credits

- @ymdvsymd ΓÇö observer sandbox and worktree fixes
- @pythonstrup ΓÇö biome hook optimization
- @Nomadu27 ΓÇö InsAIts security hook
- @hahmee ΓÇö Korean translation
- @zdocapp ΓÇö Chinese translation sync
- @cookiee339 ΓÇö Kotlin ecosystem
- @pangerlkr ΓÇö CI workflow fixes
- @0xrohitgarg ΓÇö VideoDB skills
- @nocodemf ΓÇö Evos operational skills
- @swarnika-cmd ΓÇö community contributions
